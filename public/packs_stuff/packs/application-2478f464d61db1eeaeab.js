...
/* 30 */
/*!******************************************************************!*\
  !*** ./app/javascript/packs/controllers/tutorials_controller.js ***!
  \******************************************************************/
...
var _class = function (_Controller) {
  ...
  _createClass(_class, [{
    ...
    value: function showDescription(event) {
      ...
      fetch('/api/v1/videos/' + event.target.id).then(function (response) {
        return response.json();
      }).then(function (response) {
        var desc = document.querySelector('#description-' + event.target.id);
        desc.innerHTML = response.description;
      });
    }
  }, {
    key: 'showVideoForm',
    value: function showVideoForm(event) {
      event.preventDefault();
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-2478f464d61db1eeaeab.js.map